...
**Simplifai** is an AI company that helps small business owners build a simple, sustainable marketing team using AI. The brand is warm, playful, and approachable — designed to make AI feel friendly and accessible to non-technical founders.

The name "Simplifai" evokes a penguin-like mascot energy: friendly, slightly quirky, reliably helpful.

## Sources

- `uploads/Simplifai - 1.png` — Logo variant on coral/salmon background (white blob, purple bubbly type, golden feet marks)
- `uploads/Simplifai - 2.jpg` — Logo variant on white background (golden blob, purple bubbly type, floating circles)
...
### Voice & Tone
- **Warm and encouraging** — Simplifai speaks like a knowledgeable friend, not a corporate tool
...
- **Empowering** — "You can" and "Let's" language; the user is the hero, Simplifai is the sidekick

### Person & Voice
- **First person plural ("we")** for Simplifai as a product/team: "We'll help you…"
...
Simplifai has no proprietary icon system. The recommended approach:
...
- **Usage**: Keep icon usage minimal and purposeful; Simplifai's identity is type/shape-led, not icon-led
...
assets/
  SimplifaiTransparent.png           ← Logo, transparent — light/neutral/white (primary)
  SimplifaiWhite.png                 ← White-cloud variant — coral/dark backgrounds
  SimplifaiYellow.png                ← Logo on solid yellow tile — badge on white only
