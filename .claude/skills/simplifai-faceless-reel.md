---
name: simplifai-faceless-reel
description: >
  Plan, script, and produce AI faceless videos (Instagram Reels) for Simplifai — the AI company that
  helps small business owners build a marketing SYSTEM, not buy content. Use this skill whenever
  asked to create, script, storyboard, or plan a Reel / short-form video for Simplifai's own social
  (not for Simplifai's clients). Covers the narrative spine, two production lanes (text-on-screen + AI
  voiceover, and AI presenter/avatar), reach mechanics, script structure, brand-motion spec, voice,
  compliance, and the tool workflow. Pairs with simplifai-instagram-post.md (static) and simplifai-design.md.
user-invocable: true
metadata:
  version: 1.0.0
---
...
**Every Simplifai Reel sells AI-as-a-*system*, never AI as a marketing trick.**

Simplifai's whole differentiator: *"An agency hands you content. Simplifai hands you a system."* So the
throughline across every script is:

> One-off AI prompts give you random, generic output. An AI **system** — a brand-voice doc + a
> prompt library + a workflow + a calendar (**the Simplifai Stack**) — gives you consistent, on-brand
...
- If a Reel could have been posted by any generic "AI marketing tips" account, it's wrong. Rewrite
  it until the system message is the thing only Simplifai would say.
...
Use for any Simplifai Reel or short-form video (IG Reels primary; the same export works for TikTok /
Shorts). For static feed posts or carousels, use [`simplifai-instagram-post.md`](simplifai-instagram-post.md)
instead.
...
Simplifai brand (flat + typographic), it's the cheapest to make, and it batches well — one script
...
helps — reassurance and story beats — but it is **less on-brand** (Simplifai is flat-typographic) and
...
- Keep brand text overlays and lower-third wordmark on top of the avatar so it still reads as Simplifai.
...
— same Hook / Body / CTA bones, with Simplifai specifics. Each beat carries three tracks: **on-screen
...
Pull all tokens from [`brand-guidelines/simplifai/colors_and_type.css`](../../brand-guidelines/simplifai/colors_and_type.css).
Reuse the **same 4-scheme colour rotation as static posts** so Reels match the feed — see
[`simplifai-instagram-post.md`](simplifai-instagram-post.md) "Color Rotation System" for the full table.
...
3. **Assemble:**
   - **Lane A** → CapCut or Canva (load the Simplifai brand kit / tokens) — kinetic text, b-roll /
...
|---|---|---|---|---|---|---|
| _(first batch lives in `content-calendars/Simplifai_Reels-Batch-01_2026-06.md`)_ | | | | | | |
| "This Week in AI" Ep.1 — 3 things (Canva AI 2.0 / ChatGPT memory / Meta DM agent) · series launch | 2026-06-25 | Build/Reframe | B (talking-head pilot) | B (Coral) | Save | Draft — shoot-ready |
