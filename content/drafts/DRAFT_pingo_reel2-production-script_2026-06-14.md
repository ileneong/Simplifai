...
The *script* is already written (see [Batch 01, Reel 2](../../content-calendars/Pingo_Reels-Batch-01_2026-06.md)).
...
Lane A is **flat coral + kinetic text** by default — that *is* the Pingo brand, and you can ship with
...
1. New project **1080×1920**. Load the Pingo brand kit / tokens (coral `#ff7a59`, yellow `#ffc857`, Poppins, Plus Jakarta Sans).
