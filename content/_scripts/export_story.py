"""Export Instagram Story frames to 1080x1920 PNGs via Playwright + Chromium.

Sibling of export_slides.py, for the 9:16 vertical Story format (feed posts use
export_slides.py at 1080x1350). Frame count is auto-detected by counting
elements with id="slide-N". Output goes to ./<html-stem>-slides/ (or -o dir).

Usage:
    python export_story.py DRAFT_simplifai_story-foo_2026-06-28.html
    python export_story.py foo.html -o slides
"""
...
def main():
    ...
    ap.add_argument("-n", "--slides", type=int, default=None,
                    help="Number of frames (default: auto-detect from id=\"slide-N\" elements)")
    ...
    with sync_playwright() as p:
        ...
        for html_file in args.html:
            ...
            print(f"  -> {n} frame(s) in {out_dir.name}/")
        browser.close()
    print("\nDone.")
